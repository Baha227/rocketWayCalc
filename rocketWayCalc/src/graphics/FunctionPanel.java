...
//        scaleRatio2 = 0.2;
        ...
        int firstStageX = (int)Math.round(calc.getxAxisValues().get(calc.firstStage.getMovementXValues().size()) * scaleRatio1);
        int firstStageY = (int)Math.round(calc.getyAxisValues().get(calc.firstStage.getMovementYValues().size()) * scaleRatio2);

        int secondStageX = (int)Math.round(calc.getxAxisValues().get(calc.firstStage.getMovementXValues().size() +
                calc.secondStage.getMovementXValues().size()) * scaleRatio1);
        int secondStageY = (int)Math.round(calc.getyAxisValues().get(calc.firstStage.getMovementYValues().size() +
                calc.secondStage.getMovementYValues().size()) * scaleRatio2);
